...
NEW_TYPES = [
    ...
    T('dolomite_account_deposit', 'lending', 'Dolomite margin-account deposit',
      'An asset enters DolomiteMargin, which credits a numbered internal account. A deposit may increase supplied principal or reduce an existing debt; the signed resulting balance distinguishes these cases. Proxy routing legs are one deposit, not additional capital.',
